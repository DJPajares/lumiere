...
ALTER TABLE "event_slug_aliases" ADD CONSTRAINT "event_slug_aliases_event_id_events_id_fk" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint

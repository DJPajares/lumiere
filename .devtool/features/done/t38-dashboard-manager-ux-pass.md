...
modified: "2026-07-09T15:54:00+08:00"
completedAt: "2026-07-09T15:54:00+08:00"
...
- [x] Dashboard navigation always makes the current event and editing context clear.
- [x] Overview cards explain attending, not attending, pending, total invited, max pax, and recent activity in a scannable hierarchy.
- [x] Theme, content, guest, response, and activity screens share consistent layout rhythm and action placement.
- [x] Risky edits and destructive actions have clear confirmations or draft states.
- [x] Dashboard mobile fallback supports key management tasks without broken tables or overflow.
- [x] A UX audit note records issues found and fixes applied.
...
- 2026-07-09T15:45:00+08:00: Started focused manager UX pass by reviewing `SKILL.md`, dashboard shell/navigation, event overview, theme/content/guest/response/activity workspaces, route wrappers, and existing dashboard tests.
- 2026-07-09T15:54:00+08:00: Completed dashboard manager UX pass by adding route-derived context cues, clearer event section tabs, overview cards for total groups/max pax/recent activity, dashboard route/overview test coverage, and `apps/dashboard/UX_AUDIT.md`.

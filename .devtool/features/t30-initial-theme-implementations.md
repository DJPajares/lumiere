...
Implement initial visual theme variants for Premium, Kids, Noel, and neutral default using the theme registry and Tailwind tokens.
...
- [ ] Premium theme feels polished and modern without generic AI gradients.
